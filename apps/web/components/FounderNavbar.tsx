...
const links = [
  ...
  { href: '/founder/startup', label: 'Startup' },
  { href: '/founder/listing', label: 'Listing' },
  { href: '/founder/requests', label: 'Deck Requests' },
  { href: '/founder/connections', label: 'Connections' },
];
